...
import com.piloterr.android.piloterr.models.tasks.Days
...
import com.piloterr.android.piloterr.ui.adapter.setup.TaskSetupAdapter
...
class TaskSetupFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        heartView?.setImageDrawable(BitmapDrawable(PiloterrIconsHelper.imageOfHeartLightBg()))
    }
    ...
    fun createSampleTasks(): List<Task> {
        ...
        tasks.add(makeTaskObject(Task.TYPE_TODO, getString(R.string.setup_task_join_piloterr), null, null, getString(R.string.setup_task_join_piloterr_notes)))
        return tasks
    }
