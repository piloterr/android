...
class ChallengeDetailFragment: BaseMainFragment() {
    ...
    private val challengeDescription: PiloterrEmojiTextView? by bindView(R.id.challenge_description)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        gemAmountIconView?.setImageBitmap(PiloterrIconsHelper.imageOfGem_36())
        memberCountIconView?.setImageBitmap(PiloterrIconsHelper.imageOfParticipantsIcon())
    ...
    private fun addHabits(habits: ArrayList<Task>) {
        ...
        for (i in 0 until size) {
            ...
            entry?.findViewById<ImageView>(R.id.lock_icon_plus)?.setImageBitmap(PiloterrIconsHelper.imageOfLocked(Color.parseColor("#DFDEDF")))
            entry?.findViewById<ImageView>(R.id.lock_icon_minus)?.setImageBitmap(PiloterrIconsHelper.imageOfLocked(Color.parseColor("#DFDEDF")))
            context?.let {
                if (task.up == true) {
                    entry?.findViewById<ImageView>(R.id.lock_icon_plus)?.setImageBitmap(PiloterrIconsHelper.imageOfLocked(Color.parseColor("#B3FFFFFF")))
                ...
                if (task.down == true) {
                    entry?.findViewById<ImageView>(R.id.lock_icon_minus)?.setImageBitmap(PiloterrIconsHelper.imageOfLocked(Color.parseColor("#B3FFFFFF")))
    ...
    private fun addDailys(dailies: ArrayList<Task>) {
        ...
        for (i in 0 until size) {
            ...
            entry?.findViewById<ImageView>(R.id.lock_icon)?.setImageBitmap(PiloterrIconsHelper.imageOfLocked(Color.parseColor("#949494")))
            context?.let {
    ...
    private fun addRewards(rewards: ArrayList<Task>) {
        ...
        for (i in 0 until size) {
            ...
            (entry?.findViewById<View>(R.id.gold_icon) as? ImageView)?.setImageBitmap(PiloterrIconsHelper.imageOfGold())
    ...
    private fun showChallengeLeaveDialog() {
        ...
        val alert = PiloterrAlertDialog(context)
