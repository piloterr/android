...
import com.piloterr.android.piloterr.models.user.SpecialItems
...
class SkillsRecyclerViewAdapter : RecyclerView.Adapter<SkillsRecyclerViewAdapter.SkillViewHolder>() {
    ...
    inner class SkillViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        init {
            ...
            magicDrawable = BitmapDrawable(context.resources, PiloterrIconsHelper.imageOfMagic())
            lockDrawable = BitmapDrawable(context.resources, PiloterrIconsHelper.imageOfLocked(ContextCompat.getColor(context, R.color.gray_400)))
        }
