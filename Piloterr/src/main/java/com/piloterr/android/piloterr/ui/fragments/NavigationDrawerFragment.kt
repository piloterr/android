...
import com.piloterr.android.piloterr.extensions.getRemainingString
...
import com.piloterr.android.piloterr.ui.activities.MainActivity.Companion.NOTIFICATION_CLICK
import com.piloterr.android.piloterr.ui.activities.NotificationsActivity
import com.piloterr.android.piloterr.ui.adapter.NavigationDrawerAdapter
...
class NavigationDrawerFragment : DialogFragment() {
    ...
    private fun updateUser(user: User) {
        ...
        if (item != null) {
            if (!user.hasClass() && !hasSpecialItems) {
                ...
                if (user.stats?.lvl ?: 0 < PiloterrSnackbar.MIN_LEVEL_FOR_SKILLS && (!hasSpecialItems)) {
        ...
        if (user.isSubscribed && user.purchased?.plan?.dateTerminated != null) {
            ...
            subscriptionItem?.subtitle = context?.getString(R.string.more_out_of_piloterr)
        }
    ...
    private fun initializeMenuItems() {
        val items = ArrayList<PiloterrDrawerItem>()
        context?.let {context ->
            val adventureItem = PiloterrDrawerItem(R.id.adventureGuideActivity, SIDEBAR_ADVENTURE_GUIDE)
            adventureItem.itemViewType = 4
            items.add(adventureItem)
            items.add(PiloterrDrawerItem(R.id.tasksFragment, SIDEBAR_TASKS, context.getString(R.string.sidebar_tasks)))
            items.add(PiloterrDrawerItem(R.id.skillsFragment, SIDEBAR_SKILLS, context.getString(R.string.sidebar_skills)))
            items.add(PiloterrDrawerItem(R.id.statsFragment, SIDEBAR_STATS, context.getString(R.string.sidebar_stats)))
            items.add(PiloterrDrawerItem(R.id.achievementsFragment, SIDEBAR_ACHIEVEMENTS, context.getString(R.string.sidebar_achievements)))
            if (configManager.reorderMenu()) {
                items.add(PiloterrDrawerItem(0, SIDEBAR_INVENTORY, context.getString(R.string.sidebar_shops), true))
                items.add(PiloterrDrawerItem(R.id.marketFragment, SIDEBAR_SHOPS_MARKET, context.getString(R.string.market)))
                items.add(PiloterrDrawerItem(R.id.questShopFragment, SIDEBAR_SHOPS_QUEST, context.getString(R.string.questShop)))
                items.add(PiloterrDrawerItem(R.id.seasonalShopFragment, SIDEBAR_SHOPS_SEASONAL, context.getString(R.string.seasonalShop)))
                items.add(PiloterrDrawerItem(R.id.timeTravelersShopFragment, SIDEBAR_SHOPS_TIMETRAVEL, context.getString(R.string.timeTravelers)))

                items.add(PiloterrDrawerItem(0, SIDEBAR_INVENTORY, context.getString(R.string.sidebar_section_inventory), true))
                items.add(PiloterrDrawerItem(R.id.itemsFragment, SIDEBAR_ITEMS, context.getString(R.string.sidebar_items)))
                items.add(PiloterrDrawerItem(R.id.equipmentOverviewFragment, SIDEBAR_EQUIPMENT, context.getString(R.string.sidebar_equipment)))
                items.add(PiloterrDrawerItem(R.id.stableFragment, SIDEBAR_STABLE, context.getString(R.string.sidebar_stable)))
                items.add(PiloterrDrawerItem(R.id.avatarOverviewFragment, SIDEBAR_AVATAR, context.getString(R.string.sidebar_avatar)))
                items.add(PiloterrDrawerItem(R.id.gemPurchaseActivity, SIDEBAR_GEMS, context.getString(R.string.sidebar_gems)))
                items.add(PiloterrDrawerItem(R.id.subscriptionPurchaseActivity, SIDEBAR_SUBSCRIPTION, context.getString(R.string.sidebar_subscription), isHeader = false))

                items.add(PiloterrDrawerItem(0, SIDEBAR_SOCIAL, context.getString(R.string.sidebar_section_social), true))
                items.add(PiloterrDrawerItem(R.id.tavernFragment, SIDEBAR_TAVERN, context.getString(R.string.sidebar_tavern), isHeader = false))
                items.add(PiloterrDrawerItem(R.id.partyFragment, SIDEBAR_PARTY, context.getString(R.string.sidebar_party)))
                items.add(PiloterrDrawerItem(R.id.guildsOverviewFragment, SIDEBAR_GUILDS, context.getString(R.string.sidebar_guilds)))
                items.add(PiloterrDrawerItem(R.id.challengesOverviewFragment, SIDEBAR_CHALLENGES, context.getString(R.string.sidebar_challenges)))
            } else {
                items.add(PiloterrDrawerItem(0, SIDEBAR_SOCIAL, context.getString(R.string.sidebar_section_social), true))
                items.add(PiloterrDrawerItem(R.id.tavernFragment, SIDEBAR_TAVERN, context.getString(R.string.sidebar_tavern), isHeader = false))
                items.add(PiloterrDrawerItem(R.id.partyFragment, SIDEBAR_PARTY, context.getString(R.string.sidebar_party)))
            ...
            items.add(PiloterrDrawerItem(0, SIDEBAR_ABOUT_HEADER, context.getString(R.string.sidebar_about), true))
            items.add(PiloterrDrawerItem(R.id.newsFragment, SIDEBAR_NEWS, context.getString(R.string.sidebar_news)))
            items.add(PiloterrDrawerItem(R.id.supportMainFragment, SIDEBAR_HELP, context.getString(R.string.sidebar_help)))
            items.add(PiloterrDrawerItem(R.id.aboutFragment, SIDEBAR_ABOUT, context.getString(R.string.sidebar_about)))
        }
        if (configManager.enableGiftOneGetOne()) {
            val item = PiloterrDrawerItem(R.id.subscriptionPurchaseActivity, SIDEBAR_G1G1_PROMO)
            item.itemViewType = 3
            items.add(item)
        } else if (configManager.showSubscriptionBanner()) {
            val item = PiloterrDrawerItem(R.id.subscriptionPurchaseActivity, SIDEBAR_SUBSCRIPTION_PROMO)
            item.itemViewType = 2
            items.add(item)
        }
    ...
    private fun getItemWithIdentifier(identifier: String): PiloterrDrawerItem? =
            adapter.getItemWithIdentifier(identifier)

    private fun updateItem(item: PiloterrDrawerItem) {
