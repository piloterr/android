 ...
 * Copyright © 2020 Piloterr Inc.. All rights reserved.
 *
...
public class PiloterrIcons {
    ...
    public static void drawHeart(Canvas canvas, boolean darkBackground) {
        PiloterrIcons.drawHeart(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit, darkBackground);
    }
    ...
    public static void drawHeart(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean darkBackground) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHeart.originalFrame, targetFrame, resizedFrame);
    ...
    public static void drawExperience(Canvas canvas) {
        PiloterrIcons.drawExperience(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawExperience(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForExperience.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 18f, resizedFrame.height() / 18f);
    ...
    public static void drawMagic(Canvas canvas) {
        PiloterrIcons.drawMagic(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawMagic(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForMagic.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 18f, resizedFrame.height() / 18f);
    ...
    public static void drawGold(Canvas canvas) {
        PiloterrIcons.drawGold(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawGold(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForGold.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 18f, resizedFrame.height() / 18f);
    ...
    public static void drawGem(Canvas canvas) {
        PiloterrIcons.drawGem(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawGem(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForGem.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 18f, resizedFrame.height() / 18f);
    ...
    public static void drawHourglass(Canvas canvas) {
        PiloterrIcons.drawHourglass(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawHourglass(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHourglass.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 18f, resizedFrame.height() / 18f);
    ...
    private static void drawExperienceReward(Canvas canvas) {
        PiloterrIcons.drawExperienceReward(canvas, new RectF(0f, 0f, 40f, 40f), ResizingBehavior.AspectFit);
    }
    ...
    private static void drawExperienceReward(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForExperienceReward.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        ...
        PiloterrIcons.drawExperience(canvas, symbolTargetRect, ResizingBehavior.Stretch);
        canvas.restore();
    ...
    private static void drawGoldReward(Canvas canvas) {
        PiloterrIcons.drawGoldReward(canvas, new RectF(0f, 0f, 40f, 40f), ResizingBehavior.AspectFit);
    }
    ...
    private static void drawGoldReward(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForGoldReward.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 40f, resizedFrame.height() / 40f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawGold(canvas, symbolTargetRect, ResizingBehavior.Stretch);
        canvas.restore();
    ...
    private static void drawHeartDarkBg(Canvas canvas) {
        PiloterrIcons.drawHeartDarkBg(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    private static void drawHeartDarkBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHeartDarkBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 18f, resizedFrame.height() / 18f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawHeart(canvas, symbolTargetRect, ResizingBehavior.Stretch, true);
        canvas.restore();
    ...
    private static void drawHeartLightBg(Canvas canvas) {
        PiloterrIcons.drawHeartLightBg(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    private static void drawHeartLightBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHeartLightBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 18f, resizedFrame.height() / 18f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawHeart(canvas, symbolTargetRect, ResizingBehavior.Stretch, false);
        canvas.restore();
    ...
    public static void drawWarrior(Canvas canvas, boolean darkBackground) {
        PiloterrIcons.drawWarrior(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit, darkBackground);
    }
    ...
    public static void drawWarrior(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean darkBackground) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForWarrior.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    private static void drawHeartLarge(Canvas canvas) {
        PiloterrIcons.drawHeartLarge(canvas, new RectF(0f, 0f, 36f, 36f), ResizingBehavior.AspectFit);
    }
    ...
    private static void drawHeartLarge(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHeartLarge.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawDifficultyStars(Canvas canvas, float difficulty) {
        PiloterrIcons.drawDifficultyStars(canvas, new RectF(0f, 0f, 48f, 12f), ResizingBehavior.AspectFit, difficulty);
    }
    ...
    public static void drawDifficultyStars(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, float difficulty) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForDifficultyStars.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawDifficultyStar(canvas, symbolTargetRect, ResizingBehavior.Stretch, _1StarDifficulty);
        canvas.restore();
        ...
        PiloterrIcons.drawDifficultyStar(canvas, symbol2TargetRect, ResizingBehavior.Stretch, _2StarDifficulty);
        canvas.restore();
        ...
        PiloterrIcons.drawDifficultyStar(canvas, symbol3TargetRect, ResizingBehavior.Stretch, _3StarDifficulty);
        canvas.restore();
        ...
        PiloterrIcons.drawDifficultyStar(canvas, symbol4TargetRect, ResizingBehavior.Stretch, _4StarDifficulty);
        canvas.restore();
    ...
    public static void drawDifficultyStar(Canvas canvas, float singleDifficulty) {
        PiloterrIcons.drawDifficultyStar(canvas, new RectF(0f, 0f, 12f, 12f), ResizingBehavior.AspectFit, singleDifficulty);
    }
    ...
    public static void drawDifficultyStar(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, float singleDifficulty) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForDifficultyStar.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawStarSmall(Canvas canvas) {
        PiloterrIcons.drawStarSmall(canvas, new RectF(0f, 0f, 9f, 9f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawStarSmall(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForStarSmall.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawStarLarge(Canvas canvas) {
        PiloterrIcons.drawStarLarge(canvas, new RectF(0f, 0f, 27f, 27f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawStarLarge(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForStarLarge.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawStarMedium(Canvas canvas) {
        PiloterrIcons.drawStarMedium(canvas, new RectF(0f, 0f, 21f, 21f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawStarMedium(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForStarMedium.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawPinnedItem(Canvas canvas) {
        PiloterrIcons.drawPinnedItem(canvas, new RectF(0f, 0f, 16f, 16f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawPinnedItem(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForPinnedItem.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawAddRemovePin(Canvas canvas, boolean addPin) {
        PiloterrIcons.drawAddRemovePin(canvas, new RectF(0f, 0f, 40f, 40f), ResizingBehavior.AspectFit, addPin);
    }
    ...
    public static void drawAddRemovePin(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean addPin) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForAddRemovePin.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 40f, resizedFrame.height() / 40f);
    ...
    private static void drawPinItem(Canvas canvas) {
        PiloterrIcons.drawPinItem(canvas, new RectF(0f, 0f, 40f, 40f), ResizingBehavior.AspectFit);
    }
    ...
    private static void drawPinItem(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForPinItem.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 40f, resizedFrame.height() / 40f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawAddRemovePin(canvas, symbolTargetRect, ResizingBehavior.Stretch, true);
        canvas.restore();
    ...
    private static void drawUnpinItem(Canvas canvas) {
        PiloterrIcons.drawUnpinItem(canvas, new RectF(0f, 0f, 40f, 40f), ResizingBehavior.AspectFit);
    }
    ...
    private static void drawUnpinItem(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForUnpinItem.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 40f, resizedFrame.height() / 40f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawAddRemovePin(canvas, symbolTargetRect, ResizingBehavior.Stretch, false);
        canvas.restore();
    ...
    public static void drawItemIndicator(Canvas canvas, int lockColor, boolean isLocked, boolean isLimited, boolean isDark) {
        PiloterrIcons.drawItemIndicator(canvas, new RectF(0f, 0f, 28f, 28f), ResizingBehavior.AspectFit, lockColor, isLocked, isLimited, isDark);
    }
    ...
    public static void drawItemIndicator(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int lockColor, boolean isLocked, boolean isLimited, boolean isDark) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForItemIndicator.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        ...
        if (isLocked) {
            ...
            symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
            PiloterrIcons.drawLocked(canvas, symbolTargetRect, ResizingBehavior.Stretch, lockColor);
            canvas.restore();
        }
    ...
    private static void drawItemIndicatorNumber(Canvas canvas, int lockColor) {
        PiloterrIcons.drawItemIndicatorNumber(canvas, new RectF(0f, 0f, 28f, 28f), ResizingBehavior.AspectFit, lockColor);
    }
    ...
    private static void drawItemIndicatorNumber(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int lockColor) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForItemIndicatorNumber.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 28f, resizedFrame.height() / 28f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawItemIndicator(canvas, symbolTargetRect, ResizingBehavior.Stretch, lockColor, false, false, true);
        canvas.restore();
    ...
    private static void drawItemIndicatorLocked(Canvas canvas, int lockColor) {
        PiloterrIcons.drawItemIndicatorLocked(canvas, new RectF(0f, 0f, 28f, 28f), ResizingBehavior.AspectFit, lockColor);
    }
    ...
    private static void drawItemIndicatorLocked(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int lockColor) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForItemIndicatorLocked.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 28f, resizedFrame.height() / 28f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawItemIndicator(canvas, symbolTargetRect, ResizingBehavior.Stretch, lockColor, true, false, false);
        canvas.restore();
    ...
    private static void drawItemIndicatorLimited(Canvas canvas, int lockColor) {
        PiloterrIcons.drawItemIndicatorLimited(canvas, new RectF(0f, 0f, 28f, 28f), ResizingBehavior.AspectFit, lockColor);
    }
    ...
    private static void drawItemIndicatorLimited(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int lockColor) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForItemIndicatorLimited.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 28f, resizedFrame.height() / 28f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawItemIndicator(canvas, symbolTargetRect, ResizingBehavior.Stretch, lockColor, false, true, false);
        canvas.restore();
    ...
    private static void drawGem_36(Canvas canvas) {
        PiloterrIcons.drawGem_36(canvas, new RectF(0f, 0f, 36f, 36f), ResizingBehavior.AspectFit);
    }
    ...
    private static void drawGem_36(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForGem_36.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 36f, resizedFrame.height() / 36f);
        ...
        PiloterrIcons.drawGem(canvas, gem36TargetRect, ResizingBehavior.Stretch);
        canvas.restore();
    ...
    public static void drawWarriorLightBg(Canvas canvas) {
        PiloterrIcons.drawWarriorLightBg(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawWarriorLightBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForWarriorLightBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawWarrior(canvas, symbolTargetRect, ResizingBehavior.Stretch, false);
        canvas.restore();
    ...
    public static void drawWarriorDarkBg(Canvas canvas) {
        PiloterrIcons.drawWarriorDarkBg(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawWarriorDarkBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForWarriorDarkBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawWarrior(canvas, symbolTargetRect, ResizingBehavior.Stretch, true);
        canvas.restore();
    ...
    public static void drawRogue(Canvas canvas, boolean darkBackground) {
        PiloterrIcons.drawRogue(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit, darkBackground);
    }
    ...
    public static void drawRogue(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean darkBackground) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForRogue.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
    ...
    public static void drawRogueLightBg(Canvas canvas) {
        PiloterrIcons.drawRogueLightBg(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawRogueLightBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForRogueLightBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawRogue(canvas, symbolTargetRect, ResizingBehavior.Stretch, false);
        canvas.restore();
    ...
    public static void drawRogueDarkBg(Canvas canvas) {
        PiloterrIcons.drawRogueDarkBg(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawRogueDarkBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForRogueDarkBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawRogue(canvas, symbolTargetRect, ResizingBehavior.Stretch, true);
        canvas.restore();
    ...
    public static void drawHealer(Canvas canvas, boolean darkBackground) {
        PiloterrIcons.drawHealer(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit, darkBackground);
    }
    ...
    public static void drawHealer(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean darkBackground) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHealer.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
    ...
    public static void drawHealerLightBg(Canvas canvas) {
        PiloterrIcons.drawHealerLightBg(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawHealerLightBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHealerLightBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawHealer(canvas, symbolTargetRect, ResizingBehavior.Stretch, false);
        canvas.restore();
    ...
    public static void drawHealerDarkBg(Canvas canvas) {
        PiloterrIcons.drawHealerDarkBg(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawHealerDarkBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHealerDarkBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawHealer(canvas, symbolTargetRect, ResizingBehavior.Stretch, true);
        canvas.restore();
    ...
    public static void drawMage(Canvas canvas, boolean darkBackground) {
        PiloterrIcons.drawMage(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit, darkBackground);
    }
    ...
    public static void drawMage(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean darkBackground) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForMage.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
    ...
    public static void drawMageDarkBg(Canvas canvas) {
        PiloterrIcons.drawMageDarkBg(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawMageDarkBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForMageDarkBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawMage(canvas, symbolTargetRect, ResizingBehavior.Stretch, true);
        canvas.restore();
    ...
    public static void drawMageLightBg(Canvas canvas) {
        PiloterrIcons.drawMageLightBg(canvas, new RectF(0f, 0f, 32f, 32f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawMageLightBg(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForMageLightBg.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 32f, resizedFrame.height() / 32f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawMage(canvas, symbolTargetRect, ResizingBehavior.Stretch, false);
        canvas.restore();
    ...
    public static void drawCheckmark(Canvas canvas, int checkmarkColor, float percentage) {
        PiloterrIcons.drawCheckmark(canvas, new RectF(0f, 0f, 16f, 12f), ResizingBehavior.AspectFit, checkmarkColor, percentage);
    }
    ...
    public static void drawCheckmark(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int checkmarkColor, float percentage) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForCheckmark.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawHourglassShop(Canvas canvas) {
        PiloterrIcons.drawHourglassShop(canvas, new RectF(0f, 0f, 42f, 53f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawHourglassShop(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHourglassShop.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawAttributeSparklesLeft(Canvas canvas) {
        PiloterrIcons.drawAttributeSparklesLeft(canvas, new RectF(0f, 0f, 77f, 24f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawAttributeSparklesLeft(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForAttributeSparklesLeft.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawAttributeSparklesRight(Canvas canvas) {
        PiloterrIcons.drawAttributeSparklesRight(canvas, new RectF(0f, 0f, 77f, 24f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawAttributeSparklesRight(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForAttributeSparklesRight.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 77f, resizedFrame.height() / 24f);
    ...
    public static void drawAttributeAllocateButton(Canvas canvas) {
        PiloterrIcons.drawAttributeAllocateButton(canvas, new RectF(0f, 0f, 24f, 15f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawAttributeAllocateButton(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForAttributeAllocateButton.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawInfoIcon(Canvas canvas, int infoIconColor) {
        PiloterrIcons.drawInfoIcon(canvas, new RectF(0f, 0f, 20f, 20f), ResizingBehavior.AspectFit, infoIconColor);
    }
    ...
    public static void drawInfoIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int infoIconColor) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForInfoIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawContributorBadge(Canvas canvas, float _1, boolean isNPC) {
        PiloterrIcons.drawContributorBadge(canvas, new RectF(0f, 0f, 16f, 16f), ResizingBehavior.AspectFit, _1, isNPC);
    }
    ...
    public static void drawContributorBadge(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, float _1, boolean isNPC) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForContributorBadge.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 16f, resizedFrame.height() / 16f);
    ...
    public static void drawChatLikeIcon(Canvas canvas, boolean wasLiked) {
        PiloterrIcons.drawChatLikeIcon(canvas, new RectF(0f, 0f, 12f, 12f), ResizingBehavior.AspectFit, wasLiked);
    }
    ...
    public static void drawChatLikeIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, boolean wasLiked) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForChatLikeIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 12f, resizedFrame.height() / 12f);
    ...
    public static void drawDamage(Canvas canvas) {
        PiloterrIcons.drawDamage(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawDamage(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForDamage.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 18f, resizedFrame.height() / 18f);
    ...
    public static void drawCaret(Canvas canvas, int caretColor, boolean pointsUp) {
        PiloterrIcons.drawCaret(canvas, new RectF(0f, 0f, 16f, 16f), ResizingBehavior.AspectFit, caretColor, pointsUp);
    }
    ...
    public static void drawCaret(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int caretColor, boolean pointsUp) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForCaret.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 16f, resizedFrame.height() / 16f);
    ...
    public static void drawRageStrikeInactive(Canvas canvas) {
        PiloterrIcons.drawRageStrikeInactive(canvas, new RectF(0f, 0f, 63f, 82f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawRageStrikeInactive(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForRageStrikeInactive.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawRageStrikeActive(Canvas canvas, Context context, Bitmap rageStrikeNPC) {
        PiloterrIcons.drawRageStrikeActive(canvas, context, new RectF(0f, 0f, 63f, 82f), ResizingBehavior.AspectFit, rageStrikeNPC);
    }
    ...
    public static void drawRageStrikeActive(Canvas canvas, Context context, RectF targetFrame, ResizingBehavior resizing, Bitmap rageStrikeNPC) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForRageStrikeActive.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 63f, resizedFrame.height() / 82f);
    ...
    public static void drawRage(Canvas canvas) {
        PiloterrIcons.drawRage(canvas, new RectF(0f, 0f, 18f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawRage(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForRage.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 18f, resizedFrame.height() / 18f);
    ...
    public static void drawTaskDifficultyStars(Canvas canvas, int taskTintColor, float difficulty, boolean isActive) {
        PiloterrIcons.drawTaskDifficultyStars(canvas, new RectF(0f, 0f, 36f, 36f), ResizingBehavior.AspectFit, taskTintColor, difficulty, isActive);
    }
    ...
    public static void drawTaskDifficultyStars(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int taskTintColor, float difficulty, boolean isActive) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForTaskDifficultyStars.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 36f, resizedFrame.height() / 36f);
        ...
        if (isEasy) {
            ...
            symbol2TargetRect.set(0f, 0f, symbol2Rect.width(), symbol2Rect.height());
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbol2TargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
            ...
            symbol3TargetRect.set(0f, 0f, symbol3Rect.width(), symbol3Rect.height());
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbol3TargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
        }
        ...
        if (isMedium) {
            ...
            symbol4TargetRect.set(0f, 0f, symbol4Rect.width(), symbol4Rect.height());
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbol4TargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
            ...
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbol5TargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
            ...
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbol6TargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
        }
        ...
        if (isHard) {
            ...
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbol7TargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
            ...
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbol8TargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
            ...
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbol9TargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
            ...
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbol10TargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
        }
        ...
        if (isTrivial) {
            ...
            symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
            PiloterrIcons.drawTaskFormDifficultyStar(canvas, symbolTargetRect, ResizingBehavior.Stretch, taskTintColor, isActive);
            canvas.restore();
        }
    ...
    public static void drawTaskFormDifficultyStar(Canvas canvas, int taskTintColor, boolean isActive) {
        PiloterrIcons.drawTaskFormDifficultyStar(canvas, new RectF(0f, 0f, 16f, 16f), ResizingBehavior.AspectFit, taskTintColor, isActive);
    }
    ...
    public static void drawTaskFormDifficultyStar(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int taskTintColor, boolean isActive) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForTaskFormDifficultyStar.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 16f, resizedFrame.height() / 16f);
    ...
    public static void drawHabitControlPlus(Canvas canvas, int taskTintColor, boolean isActive) {
        PiloterrIcons.drawHabitControlPlus(canvas, new RectF(0f, 0f, 34f, 34f), ResizingBehavior.AspectFit, taskTintColor, isActive);
    }
    ...
    public static void drawHabitControlPlus(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int taskTintColor, boolean isActive) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHabitControlPlus.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawHabitControlMinus(Canvas canvas, int taskTintColor, boolean isActive) {
        PiloterrIcons.drawHabitControlMinus(canvas, new RectF(0f, 0f, 34f, 34f), ResizingBehavior.AspectFit, taskTintColor, isActive);
    }
    ...
    public static void drawHabitControlMinus(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int taskTintColor, boolean isActive) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForHabitControlMinus.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 34f, resizedFrame.height() / 34f);
    ...
    public static void drawLocked(Canvas canvas, int lockColor) {
        PiloterrIcons.drawLocked(canvas, new RectF(0f, 0f, 15f, 17f), ResizingBehavior.AspectFit, lockColor);
    }
    ...
    public static void drawLocked(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int lockColor) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForLocked.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawGuildCrest(Canvas canvas, Context context, boolean isOwner, boolean isPublic, float memberCount, String memberCountLabel) {
        PiloterrIcons.drawGuildCrest(canvas, context, new RectF(0f, 0f, 40f, 38f), ResizingBehavior.AspectFit, isOwner, isPublic, memberCount, memberCountLabel);
    }
    ...
    public static void drawGuildCrest(Canvas canvas, Context context, RectF targetFrame, ResizingBehavior resizing, boolean isOwner, boolean isPublic, float memberCount, String memberCountLabel) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForGuildCrest.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawGuildCrestMedium(Canvas canvas, float memberCount) {
        PiloterrIcons.drawGuildCrestMedium(canvas, new RectF(0f, 0f, 30f, 34f), ResizingBehavior.AspectFit, memberCount);
    }
    ...
    public static void drawGuildCrestMedium(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, float memberCount) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForGuildCrestMedium.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawGuildCrestSmall(Canvas canvas, float memberCount) {
        PiloterrIcons.drawGuildCrestSmall(canvas, new RectF(0f, 0f, 16f, 16f), ResizingBehavior.AspectFit, memberCount);
    }
    ...
    public static void drawGuildCrestSmall(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, float memberCount) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForGuildCrestSmall.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 16f, resizedFrame.height() / 16f);
    ...
    public static void drawGuildHeaderCrest(Canvas canvas, int guildHeader) {
        PiloterrIcons.drawGuildHeaderCrest(canvas, new RectF(0f, 0f, 116f, 58f), ResizingBehavior.AspectFit, guildHeader);
    }
    ...
    public static void drawGuildHeaderCrest(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int guildHeader) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForGuildHeaderCrest.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawTwoHandedIcon(Canvas canvas) {
        PiloterrIcons.drawTwoHandedIcon(canvas, new RectF(0f, 0f, 15f, 15f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawTwoHandedIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForTwoHandedIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawBlankAvatarIcon(Canvas canvas) {
        PiloterrIcons.drawBlankAvatarIcon(canvas, new RectF(0f, 0f, 36f, 34f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawBlankAvatarIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForBlankAvatarIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawDisclosureArrow(Canvas canvas) {
        PiloterrIcons.drawDisclosureArrow(canvas, new RectF(0f, 0f, 8f, 13f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawDisclosureArrow(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForDisclosureArrow.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawFilterIcon(Canvas canvas, float percentage) {
        PiloterrIcons.drawFilterIcon(canvas, new RectF(0f, 0f, 22f, 22f), ResizingBehavior.AspectFit, percentage);
    }
    ...
    public static void drawFilterIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, float percentage) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForFilterIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawDeclineIcon(Canvas canvas) {
        PiloterrIcons.drawDeclineIcon(canvas, new RectF(0f, 0f, 13f, 13f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawDeclineIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForDeclineIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawAcceptIcon(Canvas canvas) {
        PiloterrIcons.drawAcceptIcon(canvas, new RectF(0f, 0f, 13f, 13f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawAcceptIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForAcceptIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 13f, resizedFrame.height() / 13f);
    ...
    public static void drawBuffIcon(Canvas canvas) {
        PiloterrIcons.drawBuffIcon(canvas, new RectF(0f, 0f, 15f, 15f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawBuffIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForBuffIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 15f, resizedFrame.height() / 15f);
    ...
    public static void drawParticipantsIcon(Canvas canvas) {
        PiloterrIcons.drawParticipantsIcon(canvas, new RectF(0f, 0f, 20f, 20f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawParticipantsIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForParticipantsIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 20f, resizedFrame.height() / 20f);
    ...
    public static void drawChatReplyIcon(Canvas canvas) {
        PiloterrIcons.drawChatReplyIcon(canvas, new RectF(0f, 0f, 17f, 17f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawChatReplyIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForChatReplyIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawChatCopyIcon(Canvas canvas) {
        PiloterrIcons.drawChatCopyIcon(canvas, new RectF(0f, 0f, 17f, 17f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawChatCopyIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForChatCopyIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 17f, resizedFrame.height() / 17f);
    ...
    public static void drawChatReportIcon(Canvas canvas) {
        PiloterrIcons.drawChatReportIcon(canvas, new RectF(0f, 0f, 17f, 18f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawChatReportIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForChatReportIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static void drawChatDeleteIcon(Canvas canvas) {
        PiloterrIcons.drawChatDeleteIcon(canvas, new RectF(0f, 0f, 17f, 17f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawChatDeleteIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForChatDeleteIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 17f, resizedFrame.height() / 17f);
    ...
    public static void drawAlertIcon(Canvas canvas) {
        PiloterrIcons.drawAlertIcon(canvas, new RectF(0f, 0f, 16f, 16f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawAlertIcon(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForAlertIcon.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 16f, resizedFrame.height() / 16f);
    ...
    private static void drawItemIndicatorLockedDark(Canvas canvas, int lockColor) {
        PiloterrIcons.drawItemIndicatorLockedDark(canvas, new RectF(0f, 0f, 28f, 28f), ResizingBehavior.AspectFit, lockColor);
    }
    ...
    private static void drawItemIndicatorLockedDark(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int lockColor) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForItemIndicatorLockedDark.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 28f, resizedFrame.height() / 28f);
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        PiloterrIcons.drawItemIndicator(canvas, symbolTargetRect, ResizingBehavior.Stretch, lockColor, true, false, true);
        canvas.restore();
    ...
    public static void drawBuffIconDark(Canvas canvas) {
        PiloterrIcons.drawBuffIconDark(canvas, new RectF(0f, 0f, 15f, 15f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawBuffIconDark(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForBuffIconDark.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 15f, resizedFrame.height() / 15f);
    ...
    public static void drawStats(Canvas canvas) {
        PiloterrIcons.drawStats(canvas, new RectF(0f, 0f, 30f, 22f), ResizingBehavior.AspectFit);
    }
    ...
    public static void drawStats(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        PiloterrIcons.resizingBehaviorApply(resizing, CacheForStats.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
    ...
    public static Bitmap imageOfExperienceReward() {
        ...
        PiloterrIcons.drawExperienceReward(canvas);
    ...
    public static Bitmap imageOfGoldReward() {
        ...
        PiloterrIcons.drawGoldReward(canvas);
    ...
    public static Bitmap imageOfHeartDarkBg() {
        ...
        PiloterrIcons.drawHeartDarkBg(canvas);
    ...
    public static Bitmap imageOfHeartLightBg() {
        ...
        PiloterrIcons.drawHeartLightBg(canvas);
    ...
    public static Bitmap imageOfHeartLarge() {
        ...
        PiloterrIcons.drawHeartLarge(canvas);
    ...
    public static Bitmap imageOfPinItem() {
        ...
        PiloterrIcons.drawPinItem(canvas);
    ...
    public static Bitmap imageOfUnpinItem() {
        ...
        PiloterrIcons.drawUnpinItem(canvas);
    ...
    public static Bitmap imageOfItemIndicatorNumber(int lockColor) {
        ...
        PiloterrIcons.drawItemIndicatorNumber(canvas, lockColor);
    ...
    public static Bitmap imageOfItemIndicatorLocked(int lockColor) {
        ...
        PiloterrIcons.drawItemIndicatorLocked(canvas, lockColor);
    ...
    public static Bitmap imageOfItemIndicatorLimited(int lockColor) {
        ...
        PiloterrIcons.drawItemIndicatorLimited(canvas, lockColor);
    ...
    public static Bitmap imageOfGem_36() {
        ...
        PiloterrIcons.drawGem_36(canvas);
    ...
    public static Bitmap imageOfInfoIcon(int infoIconColor) {
        ...
        PiloterrIcons.drawInfoIcon(canvas, infoIconColor);
    ...
    public static Bitmap imageOfContributorBadge(float _1, boolean isNPC) {
        ...
        PiloterrIcons.drawContributorBadge(canvas, _1, isNPC);
    ...
    public static Bitmap imageOfQuestBackground(PointF imageSize, int bossColorDark, int bossColorMedium, int bossColorLight) {
        ...
        PiloterrIcons.drawQuestBackground(canvas, new RectF(0f, 0f, imageSize.x, imageSize.y), bossColorDark, bossColorMedium, bossColorLight);
    ...
    public static Bitmap imageOfGuildCrest(Context context, boolean isOwner, boolean isPublic, float memberCount, String memberCountLabel) {
        ...
        PiloterrIcons.drawGuildCrest(canvas, context, isOwner, isPublic, memberCount, memberCountLabel);
    ...
    public static Bitmap imageOfGuildCrestMedium(float memberCount) {
        ...
        PiloterrIcons.drawGuildCrestMedium(canvas, memberCount);
    ...
    public static Bitmap imageOfGuildCrestSmall(float memberCount) {
        ...
        PiloterrIcons.drawGuildCrestSmall(canvas, memberCount);
    ...
    public static Bitmap imageOfGuildHeaderCrest(int guildHeader) {
        ...
        PiloterrIcons.drawGuildHeaderCrest(canvas, guildHeader);
    ...
    public static Bitmap imageOfBlankAvatarIcon() {
        ...
        PiloterrIcons.drawBlankAvatarIcon(canvas);
    ...
    public static Bitmap imageOfDisclosureArrow() {
        ...
        PiloterrIcons.drawDisclosureArrow(canvas);
    ...
    public static Bitmap imageOfFilterIcon(float percentage) {
        ...
        PiloterrIcons.drawFilterIcon(canvas, percentage);
    ...
    public static Bitmap imageOfDeclineIcon() {
        ...
        PiloterrIcons.drawDeclineIcon(canvas);
    ...
    public static Bitmap imageOfAcceptIcon() {
        ...
        PiloterrIcons.drawAcceptIcon(canvas);
    ...
    public static Bitmap imageOfItemIndicatorLockedDark(int lockColor) {
        ...
        PiloterrIcons.drawItemIndicatorLockedDark(canvas, lockColor);
    ...
    public static Bitmap imageOfBuffIconDark() {
        ...
        PiloterrIcons.drawBuffIconDark(canvas);
