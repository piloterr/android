package com.piloterr.android.piloterr.ui.menu

import android.graphics.drawable.Drawable
import android.os.Bundle
import com.piloterr.android.piloterr.models.user.User

data class PiloterrDrawerItem(var transitionId: Int, val identifier: String, val text: String, val isHeader: Boolean = false) {
