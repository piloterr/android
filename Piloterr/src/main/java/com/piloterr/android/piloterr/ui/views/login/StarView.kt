package com.piloterr.android.piloterr.ui.views.login
...
class StarView : AppCompatImageView {
    ...
    fun setStarSize(size: Int) {
        when (size) {
            0 -> {
                this.setImageBitmap(PiloterrIconsHelper.imageOfStarSmall())
            }
            1 -> {
                this.setImageBitmap(PiloterrIconsHelper.imageOfStarMedium())
            }
            2 -> {
                this.setImageBitmap(PiloterrIconsHelper.imageOfStarLarge())
            }
        }
    }
