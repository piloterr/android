...
import com.piloterr.android.piloterr.ui.views.login.LockableScrollView
import com.piloterr.android.piloterr.ui.views.login.LoginBackgroundView
...
class LoginActivity : BaseActivity(), Consumer<UserAuthResponse> {
    ...
    override fun accept(userAuthResponse: UserAuthResponse) {
        ...
        PiloterrBaseApplication.reloadUserComponent()
    ...
    private fun onForgotPasswordClicked() {
        ...
        val alertDialog = PiloterrAlertDialog(this)
