package com.piloterr.android.piloterr.ui.views.subscriptions
...
import com.piloterr.android.piloterr.databinding.SubscriptionDetailsBinding
import com.piloterr.android.piloterr.extensions.layoutInflater
import com.piloterr.android.piloterr.models.user.SubscriptionPlan
...
class SubscriptionDetailsView : LinearLayout {
    ...
    private fun setupView() {
        ...
        binding.heartIcon.setImageDrawable(BitmapDrawable(context.resources, PiloterrIconsHelper.imageOfHeartLightBg()))
    }
    ...
    fun setPlan(plan: SubscriptionPlan) {
        ...
        if (plan.paymentMethod != null) {
            ...
            if (plan.paymentMethod == "Google") {
                ...
                binding.changeSubscriptionButton.setText(R.string.visit_piloterr_website)
            }
        }
