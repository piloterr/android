...
open class DragLinearLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : LinearLayout(context, attrs) {
    ...
    /**
     * Use with [com.piloterr.android.piloterr.ui.views.DragLinearLayout.setOnViewSwapListener]
    ...
    /**
     * See [com.piloterr.android.piloterr.ui.views.DragLinearLayout.OnViewSwapListener].
     */
     ...
     * [com.piloterr.android.piloterr.ui.views.DragLinearLayout.DragItem.detecting].
     */
