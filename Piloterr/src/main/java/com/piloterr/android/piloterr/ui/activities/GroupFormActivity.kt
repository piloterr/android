...
import com.piloterr.android.piloterr.ui.views.PiloterrAutocompleteTextView
...
class GroupFormActivity : BaseActivity() {
    ...
    private val groupNameEditText: PiloterrAutocompleteTextView by bindView(R.id.group_name_edittext)
    private val groupDescriptionEditText: PiloterrAutocompleteTextView by bindView(R.id.group_description_edittext)
