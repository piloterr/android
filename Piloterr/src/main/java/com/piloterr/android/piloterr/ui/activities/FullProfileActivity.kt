...
import com.piloterr.android.piloterr.databinding.ActivityFullProfileBinding
...
import com.piloterr.android.piloterr.ui.adapter.social.AchievementProfileAdapter
import com.piloterr.android.piloterr.ui.helpers.bindView
import com.piloterr.android.piloterr.ui.helpers.dismissKeyboard
import com.piloterr.android.piloterr.ui.helpers.loadImage
...
class FullProfileActivity : BaseActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when {
            ...
            item.itemId == R.id.copy_username -> {
                ...
                PiloterrSnackbar.showSnackbar(this@FullProfileActivity.scrollView.getChildAt(0) as ViewGroup,
    ...
    private fun showSendMessageToUserDialog() {
        ...
        val addMessageDialog = PiloterrAlertDialog(this)
