...
class AboutFragment : BaseMainFragment() {
    ...
    private val androidSourceCodeLink = "https://github.com/Piloterr/piloterr-android/"
    private val twitterLink = "https://twitter.com/piloterr"

    private var versionNumberTappedCount = 0

    private fun openGooglePlay() {
        val intent = Intent(Intent.ACTION_VIEW)
        intent.data = "market://details?id=com.piloterr.android.piloterr".toUri()
