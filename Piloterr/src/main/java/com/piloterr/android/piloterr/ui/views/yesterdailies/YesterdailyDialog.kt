package com.piloterr.android.piloterr.ui.views.yesterdailies
...
import com.piloterr.android.piloterr.ui.helpers.bindColor
...
class YesterdailyDialog private constructor(context: Context, private val userRepository: UserRepository, private val taskRepository: TaskRepository, private val tasks: List<Task>) : PiloterrAlertDialog(context) {
    ...
    private fun configureTaskView(taskView: View, task: Task) {
        ...
        val emojiView = taskView.findViewById<View>(R.id.text_view) as? PiloterrEmojiTextView
