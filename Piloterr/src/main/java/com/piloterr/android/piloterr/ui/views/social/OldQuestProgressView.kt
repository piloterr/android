...
class OldQuestProgressView : LinearLayout {
    ...
    private fun setupView(context: Context) {
        ...
        bossHealthView.setSecondaryIcon(PiloterrIconsHelper.imageOfHeartLightBg())
        bossHealthView.setDescriptionIcon(PiloterrIconsHelper.imageOfDamage())
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        PiloterrIcons.drawQuestBackground(canvas, rect, lightGray, darkGray, mediumGray)
