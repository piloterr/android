...
import com.piloterr.android.piloterr.models.shops.ShopCategory
...
import com.piloterr.android.piloterr.ui.viewHolders.ShopItemViewHolder
import com.piloterr.android.piloterr.ui.views.NPCBannerView
            ...
            when (obj.javaClass) {
                ...
                ShopCategory::class.java -> {
                    ...
                    if (gearCategories.contains(category)) {
                        context?.let {context ->
                            val adapter = PiloterrClassArrayAdapter(context, R.layout.class_spinner_dropdown_item, gearCategories.map { it.identifier })
