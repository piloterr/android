package com.piloterr.android.piloterr.ui.fragments.inventory.items
...
import com.piloterr.android.piloterr.ui.adapter.inventory.ItemRecyclerAdapter
                        ...
                        .doOnNext {
                            ...
                            if (activity != null) {
                                DataBindingUtils.loadImage("shop_${it.key}") {image ->
                                    showSnackbar(activity.snackbarContainer, BitmapDrawable(context?.resources, image), null, getString(R.string.mystery_item_received, it.text), PiloterrSnackbar.SnackbarDisplayType.NORMAL)
                                }
                            }
                        }
