...
import com.piloterr.android.piloterr.ui.adapter.social.InboxAdapter
import com.piloterr.android.piloterr.ui.fragments.BaseMainFragment
import com.piloterr.android.piloterr.ui.helpers.KeyboardUtil
...
import com.piloterr.android.piloterr.ui.viewmodels.InboxViewModelFactory
...
class InboxMessageListFragment : BaseMainFragment(), androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener {
    ...
    private fun copyMessageToClipboard(chatMessage: ChatMessage) {
        ...
        if (activity != null) {
            showSnackbar(activity.snackbarContainer, getString(R.string.chat_message_copied), PiloterrSnackbar.SnackbarDisplayType.NORMAL)
        }
    }
