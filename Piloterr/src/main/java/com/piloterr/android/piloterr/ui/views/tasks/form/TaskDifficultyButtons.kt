...
import com.piloterr.android.piloterr.models.tasks.TaskDifficulty
...
class TaskDifficultyButtons @JvmOverloads constructor(
    ...
    private fun createButton(difficulty: TaskDifficulty): View {
        ...
        val drawable = PiloterrIconsHelper.imageOfTaskDifficultyStars(difficultyColor, difficulty.value, true).asDrawable(resources)
