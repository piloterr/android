...
import com.piloterr.android.piloterr.events.GearPurchasedEvent
...
import com.piloterr.android.piloterr.ui.views.CurrencyViews
...
import com.piloterr.android.piloterr.ui.views.insufficientCurrency.InsufficientGoldDialog
import com.piloterr.android.piloterr.ui.views.insufficientCurrency.InsufficientHourglassesDialog
import com.piloterr.android.piloterr.ui.views.insufficientCurrency.InsufficientSubscriberGemsDialog
...
class PurchaseDialog(context: Context, component: UserComponent?, val item: ShopItem) : PiloterrAlertDialog(context) {
    ...
    var isPinned: Boolean = false
        set(value) {
            field = value
            if (isPinned) {
                pinButton.setCompoundDrawablesWithIntrinsicBounds(BitmapDrawable(context.resources, PiloterrIconsHelper.imageOfUnpinItem()), null, null, null)
                pinButton.setTextColor(ContextCompat.getColor(context, R.color.red_10))
                pinButton.text = context.getText(R.string.unpin)
            } else {
                pinButton.setCompoundDrawablesWithIntrinsicBounds(BitmapDrawable(context.resources, PiloterrIconsHelper.imageOfPinItem()), null, null, null)
    ...
    private fun buyItem(quantity: Int) {
        ...
        val subscription = observable
                .doOnNext {
                    ...
                    event.type = PiloterrSnackbar.SnackbarDisplayType.NORMAL
